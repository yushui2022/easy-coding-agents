...
- `retrieval_hit_rate`: expected answer terms are present in the built memory context.
- `evidence_precision`: expected evidence terms are present.
...
- `source_coverage`: retrieved rows carry event/ref/source metadata.
...
The runner writes JSON and Markdown results to:
